package com.tugas.StoryApp.view.customview
...
class NameCostumView : AppCompatEditText {
    ...
    private fun init() {
        personIcon = ContextCompat.getDrawable(context, R.drawable.ic_baseline_person) as Drawable
